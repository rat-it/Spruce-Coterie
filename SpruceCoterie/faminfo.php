...
<div class="container" style="margin-top:50px">
	<div class="row">
		<div class="col-sm-3">
			...
			<ul class="nav nav-pills flex-column">
				...
				<?php
					...
					$sqll = "SELECT * FROM `".$_SESSION['user']."`";
					$result = mysqli_query($con,$sqll);
					if(mysqli_query($con, $sqll)){
					while($row = mysqli_fetch_array($result))
					{
						echo '<li class="nav-item" ><a class="nav-link" href="#" style="margin-left:15px">  '.$row["col"].'</a></li>';
					}
					}
					mysqli_close($con);
		...
		<div class="col-sm-6">
			<?php 
				$sql1 = "SELECT * FROM family WHERE id =".$_SESSION['fid']."";
				$con = new mysqli("localhost","root","","sprucecoteriedb");
				if (!$con){
					die('Could not connect: ' . mysql_error());
				}
			...
			<?php 
				...
				$sql4 = "SELECT * from fmem where user = '".$_SESSION['user']."'";
				...
				$sql7 = "SELECT * FROM fmem WHERE fid=".$fid."";
