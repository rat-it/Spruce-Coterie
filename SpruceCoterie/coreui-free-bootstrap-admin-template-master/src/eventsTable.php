...
#trial tr:nth-child(even){background-color: #f2f2f2;}

#trial tr:hover {background-color: #ddd;}
...
#trial th {
  ...
  color: white;
    ...
    $(document).ready(function(){
     $.ajax({
		 console.log("tarrararararar");
       url: "http://localhost:8080/SpruceCoterie/coreui-free-bootstrap-admin-template-master/src/loginData.php",
       method: "GET",
   ...
   <script type="text/javascript">
    $(document).ready(function(){
     ...
     $.ajax({
       url: "http://localhost:8080/SpruceCoterie/coreui-free-bootstrap-admin-template-master/src/familyData.php",
       method: "GET",
       success: function(data1) {
         var numOfFamilies=0;
         var data = JSON.parse(data1)
  ...
  <script type="text/javascript">
   $(document).ready(function(){
    $.ajax({
      url: "http://localhost:8080/SpruceCoterie/coreui-free-bootstrap-admin-template-master/src/eventsData.php",
      method: "GET",
      success: function(data1) {
   ...
   $(document).ready(function(){
    $.ajax({
      url: "http://localhost:8080/SpruceCoterie:8080/SpruceCoterie/coreui-free-bootstrap-admin-template-master/src/loginData.php",
      method: "GET",
      success: function(data1) {
        ...
        <div class="container-fluid">
          <div class="animated fadeIn">
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-primary">
                  <div class="card-body pb-0">
                    ...
                    <div class="text-value" id="memberRegistered">2</div>
            ...
            <div class="row"  >
             ...
             . $row["ename"]. "</td><td>".$row['eabout']."</td><td>".$row["date"]."</td></tr>";
             }
             echo "</table>";
             } else { echo "0 results"; }
             $conn->close();
