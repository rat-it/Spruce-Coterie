...
#trial th {
  ...
  <script type="text/javascript">
   $(document).ready(function(){
    $.ajax({
      url: "http://localhost:8080/SpruceCoterie:8080/SpruceCoterie/coreui-free-bootstrap-admin-template-master/src/eventsData.php",
      method: "GET",
      success: function(data1) {
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-info">
                  <div class="card-body pb-0">
                    ...
                    <div class="text-value" id = "numberOfEventsPosted">2</div>
             ...
             $conn = mysqli_connect("localhost", "root", "", "sprucecoteriedb");
               ...
               if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                 echo "<tr><td>" . $row["id"]. "</td><td>" . $row["familyname"] . "</td><td>"
             . $row["description"]. "</td><td>".$row['email']."</td><td>".$row["date"]."</td></tr>";
             }
             echo "</table>";
             } else { echo "0 results"; }
             $conn->close();
